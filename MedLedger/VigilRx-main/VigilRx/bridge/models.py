...
from VigilRx.app.dashboard.models import Transaction
...
class Registrar():
    ...
    def __init__(self):
        ...
        template = w3.eth.contract(
            abi=bridge_module.REGISTRAR_ABI,
            bytecode=bridge_module.REGISTRAR_BIN
        )
        try:
...
class Patient(Roles):
    ...
    def __init__(self, personal_address):
        ...
        self.contract = w3.eth.contract(address=self.contract_address, abi=bridge_module.PATIENT_ABI)
        self.runtime = {
            'add_permissioned': 0,
...
class Prescriber(Provider):
    ...
    def __init__(self, personal_address, npi):
        ...
        self.contract = w3.eth.contract(address=self.contract_address, abi=bridge_module.PRESCRIBER_ABI)
...
class Pharmacy(Provider):
    ...
    def __init__(self, personal_address, npi):
        ...
        self.contract = w3.eth.contract(address=self.contract_address, abi=bridge_module.PHARMACY_ABI)
    ...
    def request_refill(self, prescription_address):
        ...
        tx_ew3.eth.wait_for_transaction_receipt(tx_hash)
